package com.vitnob.myapp.web.websocket;

import com.vitnob.myapp.security.SecurityUtils;
import com.vitnob.myapp.web.websocket.dto.ActivityDTO;
...
import static com.vitnob.myapp.config.WebsocketConfiguration.IP_ADDRESS;
